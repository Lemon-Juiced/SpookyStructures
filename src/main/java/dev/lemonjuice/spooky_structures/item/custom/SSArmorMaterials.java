...
public class SSArmorMaterials {
    public static final Holder<ArmorMaterial> ECTOPLASM_ARMOR_MATERIAL = register("ectoplasm",
            ...
            }), 16, 2f, 0.1f, SSItems.ECTOPLASM_INFUSED_SILVER_INGOT::get);
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection, int enchantability, float toughness, float knockbackResistance, Supplier<Item> ingredientItem) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(SpookyStructures.MOD_ID, name);
